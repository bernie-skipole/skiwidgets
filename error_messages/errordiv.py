...
def index(skicall):
    ...
    headersection['title', 'large_text'] = 'ErrorDiv'
    # A textblock contains the widget description
    ref = "widgets.error_messages.ErrorDiv"
...
def show_error(skicall):
    "Called by a button to show the ErrorDiv widget"
    ...
    # raise an error to be shown in the ErrorDiv widget
    raise FailPage(message = 'This is an error message', widget='errordiv') 
