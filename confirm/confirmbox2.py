...
def index(skicall):
    ...
    headersection['title', 'large_text'] = 'ConfirmBox2'
    # A textblock contains the widget description
    ref = "widgets.confirm.ConfirmBox2"
...
def show_widget(skicall):
    ...
    pd = PageData()
    pd['confirmbox2', 'hide'] = False
    pd['result', 'para_text'] = "Awaiting confirm action"
    skicall.update(pd)


def confirm(skicall):
    "Responds to confirm submission from confirmbox2"

    pd = PageData()
    pd['confirmbox2', 'hide'] = True
