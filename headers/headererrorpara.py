...
def index(skicall):
    ...
    headersection['title', 'large_text'] = 'HeaderErrorPara'
    # A textblock contains the widget description
    ref = "widgets.headers.HeaderErrorPara"
...
def show_error(skicall):
    "Called by a button to show the HeaderErrorPara widget"
    ...
    # raise an error to be shown in the ErrorPara widget
    raise FailPage(message = 'This is an error message', widget='headererrorpara') 
